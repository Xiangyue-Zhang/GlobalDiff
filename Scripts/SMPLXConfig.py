...
def GetBodyPartIndices(part_name="upper", rotation_method='axisangle'):
    if part_name == "upper":
        part_name = "beat_smplx_upper"
    elif part_name == "lower":
        part_name = "beat_smplx_lower"
    elif part_name == "hand":
        part_name = "beat_smplx_hands"
    elif part_name == "face":
        part_name = "beat_smplx_face_3"
    elif part_name == "all":
        part_name = "beat_smplx_full"
    elif part_name == "lhand":
        part_name = "beat_smplx_lhands"
    elif part_name == "rhand":
        part_name = "beat_smplx_rhands"
    else:
        assert 0 == 1
    upper_names = joints_list[part_name].keys()
    upper_start_indices = [joints_list['beat_smplx_joints']
                           [name][1] // 3 - 1 for name in upper_names]
    upper_indices = []

    offset = 3
    if rotation_method == 'axisangle':
        offset = 3
    elif rotation_method == 'rot6d':
        offset = 6
    elif rotation_method == None:
        offset = 1
    else:
        assert 0 == 1
    for idx in upper_start_indices:
        upper_indices = upper_indices + \
            list(range(idx * offset, idx * offset+offset))
...
if __name__ == '__main__':
    print("#beat_smplx_upper", len(joints_list['beat_smplx_upper']))
    print("#beat_smplx_lower", len(joints_list['beat_smplx_lower']))
    print("#beat_smplx_hands", len(joints_list['beat_smplx_hands']))
    print("#beat_smplx_face_3", len(joints_list['beat_smplx_face_3']))

  
    print((GetBodyPartIndices("lower")[0::3]))
