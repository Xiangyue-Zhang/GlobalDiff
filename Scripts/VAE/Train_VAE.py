...
import random
import numpy as np
from VAE import VAE3, ReconsLoss
...
def main():
    ...
    parser.add_argument("--ckpt_folder", type=str, default="ckpt/split/global/VAE3-HorizonFlip")
    ...
    net = VAE3(in_channels=55 * 6 + (3 if args.include_translation else 0), 
               hidden_size=256,
            #    latent_dim=128,
            ...
            if (epoch + 1) % 5 == 0:
                ...
                for batch_idx, data in enumerate(test_dataloader):
                    ...
                    if args.include_translation:
                        ...
                        motion = poses
                    with torch.no_grad():
                        rec, mu, logvar = net(motion, False)
